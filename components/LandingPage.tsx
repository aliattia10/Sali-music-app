...
const LandingPage: React.FC<LandingPageProps> = ({ onNavigate }) => {
  return (
    <div className="relative flex flex-col min-h-screen w-full">
      {/* Header */}
      <header className="sticky top-0 z-50 flex items-center justify-between whitespace-nowrap border-b border-solid border-[#e6e6dc] dark:border-[#3a392a] bg-background-light/90 dark:bg-background-dark/90 backdrop-blur-md px-4 md:px-10 py-4 transition-colors duration-300">
        <div className="flex items-center gap-3 text-[#1c1c0d] dark:text-white">
          <div className="size-8 flex items-center justify-center bg-black dark:bg-primary text-primary dark:text-black rounded-full">
            <span className="material-symbols-outlined text-xl">equalizer</span>
          </div>
          <h2 className="text-xl font-bold leading-tight tracking-tight">Salimusic</h2>
        </div>
        <div className="flex flex-1 justify-end gap-4 md:gap-8 items-center">
          <div className="hidden md:flex items-center gap-9">
            <a className="text-[#1c1c0d] dark:text-[#e6e6dc] text-sm font-medium hover:text-primary transition-colors" href="#">Shop</a>
            <a className="text-[#1c1c0d] dark:text-[#e6e6dc] text-sm font-medium hover:text-primary transition-colors" href="#">About</a>
            <a className="text-[#1c1c0d] dark:text-[#e6e6dc] text-sm font-medium hover:text-primary transition-colors" href="#">FAQ</a>
          </div>
            ...
            <div className="flex flex-col-reverse gap-10 md:flex-row md:items-center md:justify-between">
              ...
              <div className="flex flex-col gap-8 md:w-1/2 md:pr-10">
                <div className="flex flex-col gap-4 text-left">
                  ...
                  <h1 className="text-[#1c1c0d] dark:text-white text-5xl md:text-7xl font-black leading-[0.95] tracking-tight">
                    Music you <br />
                    <span className="bg-primary px-2 text-black italic">wear.</span>
                  </h1>
                  <h2 className="text-[#4a4a40] dark:text-[#b0b0a0] text-lg md:text-xl font-normal leading-relaxed max-w-lg">
                ...
                <div className="flex flex-wrap gap-4">
                  <button 
                    ...
                    className="flex cursor-pointer items-center justify-center overflow-hidden rounded-full h-12 px-8 bg-black dark:bg-[#fcfcf8] text-primary dark:text-black text-base font-bold tracking-wide hover:scale-105 transition-transform duration-200 shadow-lg shadow-primary/20"
                  >
                    <span className="truncate">Start Creating</span>
                  </button>
                  <button 
                    onClick={() => onNavigate('drop')}
                    className="flex cursor-pointer items-center justify-center overflow-hidden rounded-full h-12 px-8 bg-transparent border-2 border-[#1c1c0d] dark:border-white text-[#1c1c0d] dark:text-white text-base font-bold tracking-wide hover:bg-[#1c1c0d] hover:text-primary dark:hover:bg-white dark:hover:text-black transition-all duration-200"
                  >
                ...
                <div className="flex items-center gap-3 pt-2">
                  ...
                  <p className="text-sm font-medium text-[#4a4a40] dark:text-[#b0b0a0]">Join 10k+ creators</p>
                </div>
              </div>
              {/* Hero Image */}
              <div className="md:w-1/2 relative group">
                <div className="absolute inset-0 bg-primary blur-[80px] opacity-30 rounded-full scale-75 group-hover:scale-90 transition-transform duration-700"></div>
                <div className="w-full aspect-[4/5] md:aspect-square rounded-[2.5rem] bg-gray-100 dark:bg-[#1a190b] overflow-hidden border border-[#e6e6dc] dark:border-[#3a392a] relative shadow-2xl">
      ...
      {/* Timer Section */}
      <section className="flex justify-center py-16 bg-[#f4f4e6] dark:bg-[#1c1b0d]">
        <div className="layout-content-container flex flex-col max-w-[960px] w-full px-4">
          <div className="text-center mb-8">
            <h2 className="text-lg font-bold tracking-widest uppercase text-[#4a4a40] dark:text-[#b0b0a0]">Unlock Phase Begins In</h2>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8">
            <div className="flex flex-col items-center gap-2">
              <div className="flex h-24 w-full md:w-32 items-center justify-center rounded-[2rem] bg-white dark:bg-[#2a2915] border border-[#e6e6dc] dark:border-[#3a392a] shadow-sm">
                <p className="text-black dark:text-primary text-5xl font-black tracking-tighter tabular-nums">04</p>
              </div>
              <p className="text-sm font-bold uppercase tracking-wider opacity-60">Days</p>
            </div>
            <div className="flex flex-col items-center gap-2">
              <div className="flex h-24 w-full md:w-32 items-center justify-center rounded-[2rem] bg-white dark:bg-[#2a2915] border border-[#e6e6dc] dark:border-[#3a392a] shadow-sm">
                <p className="text-black dark:text-primary text-5xl font-black tracking-tighter tabular-nums">12</p>
              </div>
              <p className="text-sm font-bold uppercase tracking-wider opacity-60">Hours</p>
            </div>
            <div className="flex flex-col items-center gap-2">
              <div className="flex h-24 w-full md:w-32 items-center justify-center rounded-[2rem] bg-white dark:bg-[#2a2915] border border-[#e6e6dc] dark:border-[#3a392a] shadow-sm">
                <p className="text-black dark:text-primary text-5xl font-black tracking-tighter tabular-nums">45</p>
              </div>
              <p className="text-sm font-bold uppercase tracking-wider opacity-60">Minutes</p>
            </div>
            <div className="flex flex-col items-center gap-2">
              <div className="flex h-24 w-full md:w-32 items-center justify-center rounded-[2rem] bg-white dark:bg-[#2a2915] border border-[#e6e6dc] dark:border-[#3a392a] shadow-sm">
                <p className="text-black dark:text-primary text-5xl font-black tracking-tighter tabular-nums">30</p>
              </div>
        ...
        <div className="layout-content-container flex flex-col max-w-[1200px] w-full gap-16">
          <div className="flex flex-col md:flex-row gap-8 justify-between items-end">
            <div className="flex flex-col gap-4 max-w-2xl">
              <h2 className="text-[#1c1c0d] dark:text-white text-4xl md:text-5xl font-black leading-none tracking-tight">
                From Data <br />
                to <span className="underline decoration-primary decoration-8 underline-offset-4">Thread</span>
              </h2>
              <p className="text-[#4a4a40] dark:text-[#b0b0a0] text-lg font-normal leading-relaxed">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="group flex flex-col gap-6 rounded-[2rem] border border-[#e6e6dc] dark:border-[#3a392a] bg-white dark:bg-[#1c1b0d] p-8 hover:border-primary dark:hover:border-primary transition-colors duration-300">
              <div className="size-16 rounded-2xl bg-primary/20 flex items-center justify-center text-black dark:text-primary group-hover:bg-primary group-hover:text-black transition-colors duration-300">
                <span className="material-symbols-outlined text-4xl">music_note</span>
              </div>
              <div className="flex flex-col gap-2">
                <h3 className="text-[#1c1c0d] dark:text-white text-xl font-bold">1. Connect & Stream</h3>
                <p className="text-[#4a4a40] dark:text-[#b0b0a0] leading-relaxed">
            ...
            <div className="group flex flex-col gap-6 rounded-[2rem] border border-[#e6e6dc] dark:border-[#3a392a] bg-white dark:bg-[#1c1b0d] p-8 hover:border-primary dark:hover:border-primary transition-colors duration-300">
              ...
              <div className="flex flex-col gap-2">
                <h3 className="text-[#1c1c0d] dark:text-white text-xl font-bold">2. We Analyze</h3>
                <p className="text-[#4a4a40] dark:text-[#b0b0a0] leading-relaxed">
            ...
            <div className="group flex flex-col gap-6 rounded-[2rem] border border-[#e6e6dc] dark:border-[#3a392a] bg-white dark:bg-[#1c1b0d] p-8 hover:border-primary dark:hover:border-primary transition-colors duration-300">
              ...
              <div className="flex flex-col gap-2">
                <h3 className="text-[#1c1c0d] dark:text-white text-xl font-bold">3. The Drop</h3>
                <p className="text-[#4a4a40] dark:text-[#b0b0a0] leading-relaxed">
      ...
      {/* Footer */}
      <footer className="border-t border-[#e6e6dc] dark:border-[#3a392a] bg-white dark:bg-[#1c1b0d] py-12 px-10">
        <div className="max-w-[1200px] mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
          <div className="flex flex-col gap-2 items-center md:items-start">
            <h2 className="text-2xl font-black text-black dark:text-white">Salimusic</h2>
            <p className="text-sm text-[#4a4a40] dark:text-[#b0b0a0]">© 2024 Salimusic Inc. All rights reserved.</p>
          </div>
          <div className="flex gap-6">
            <a className="text-[#1c1c0d] dark:text-[#e6e6dc] hover:text-primary transition-colors" href="#"><span className="material-symbols-outlined">public</span></a>
            <a className="text-[#1c1c0d] dark:text-[#e6e6dc] hover:text-primary transition-colors" href="#"><span className="material-symbols-outlined">alternate_email</span></a>
            <a className="text-[#1c1c0d] dark:text-[#e6e6dc] hover:text-primary transition-colors" href="#"><span className="material-symbols-outlined">help</span></a>
          </div>
        </div>
      </footer>
    </div>
